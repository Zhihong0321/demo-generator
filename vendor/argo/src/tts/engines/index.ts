...
import { MiniMaxEngine, type MiniMaxEngineOptions } from './minimax.js';
...
export const engines = {
  ...
  minimax: (opts?: MiniMaxEngineOptions): TTSEngine => new MiniMaxEngine(opts),
};
...
export type { MiniMaxEngineOptions } from './minimax.js';
...
export { MiniMaxEngine } from './minimax.js';
